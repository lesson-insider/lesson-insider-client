...
import styles from "./QuestionFormForDiscussion.module.css";
...
export default function QuestionFormForDiscussion({ handleCloseModalButton }) {
        ...
        <div className={styles.NewPostForm}>
            ...
            <Form autoComplete="off" nonValidate onSubmit={handleSubmit}>
                ...
                >
                    ...
                    <Form.Control
                        as="textarea"
                        placeholder="Write question details here..."
                        name="contentDetails"
                ...
                <Chips
                    ...
                    placeholder="tags are the only way to access this question directly"
                ...
                <Row>
                    <Col>
                        ...
                        />
                        <Button
                            // ekhon close korar function likha ase .. pore question post korar functionality
                            // likhte hobe
                            onClick={handleCloseModalButton}
                            variant="primary"
                            type="submit"
